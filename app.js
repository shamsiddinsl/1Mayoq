...
function renderWeeklyChart() {
  ...
  weeklyChart = new Chart(ctx, {
    ...
    data: {
      labels,
      datasets: [
        { label: "Foydali", data: usefulData, backgroundColor: "#4FD1AE", borderRadius: 4 },
        { label: "Neytral", data: neutralData, backgroundColor: "#7C8CA6", borderRadius: 4 },
        { label: "Foydasiz", data: uselessData, backgroundColor: "#E8664F", borderRadius: 4 },
      ],
    },
    options: {
      responsive: true,
      ...
      scales: {
        x: { stacked: true, ticks: { color: "#647289" }, grid: { color: "#223247" } },
